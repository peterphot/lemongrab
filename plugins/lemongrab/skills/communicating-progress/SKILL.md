...
- Valid phase values: `CLARIFY_IN_PROGRESS`, `CLARIFY_COMPLETE`, `PLAN_IN_PROGRESS`,
  `PLAN_COMPLETE`, `PLAN_APPROVED`, `TICKETS_PENDING`, `TICKETS_COMPLETE`,
  `BRANCH_CREATED`, `BUILD_IN_PROGRESS`, `BUILD_COMPLETE`, `PR_CREATED`,
  `DOCUMENT_IN_PROGRESS`, `DOCUMENT_COMPLETE`, `COMPLETE`

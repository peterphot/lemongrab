...
- Still produce docs/requirements/<feature>.md — even brief docs MUST include all required sections
  listed in shared/requirements-doc-format.md (even if sections are short)
...
- Required sections as defined in shared/requirements-doc-format.md
...
IMPORTANT: Before writing the requirements doc, read shared/requirements-doc-format.md
